package com.okedroid.swiperefreshlayoutandloadmore;
...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Belajar Swipe and LoadMore");
        getSupportActionBar().setSubtitle("Modul 3 Dicoding.com(Fathurrahman)");

        lvItem = (LoadMoreListView)findViewById(R.id.lv_item);
        swipeMain = (SwipeRefreshLayout)findViewById(R.id.swipe_view);
        list = new LinkedList<>();
    ...
    private void populateLoadmoreData() {
        String loadmoreText = "Ditambahkan data pada Load More";
        for (int i = 0; i < 5; i++){
    ...
    private void populatePullRefreshData() {
        String swipePullRefreshText = "Ditambahkan setelah user menswipe layar";
